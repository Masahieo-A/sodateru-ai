      ...
      <main className="max-w-2xl mx-auto px-4 py-12">
        <div className="space-y-8">
          <div className="text-center py-6">
            <AppIcon name="plant" size={64} className="mb-4 text-green-600" />
            <h1 className="text-3xl font-black text-gray-900 mb-3">育てるAI</h1>
            <p className="text-gray-600 leading-relaxed">
              ソウタに英文法を<span className="font-bold text-indigo-600">教えて</span>みよう。
              <br />
              基本を教え、ソウタと対話しながら練習し、最後はテストで力試し。
              <br />
              あなたの教え方が、ソウタの理解度を決める。
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <ol className="space-y-3">
              {[
                ["note", "基本を教える", "ソウタに文法の基本ルールを説明する"],
                ["chat", "対話で練習", "ソウタが練習問題を解き、つまずきを質問。あなたが追加で教える"],
                ["book", "学習内容を確認", "ソウタが何を学んだかをまとめて振り返る"],
                ["target", "テストでスコア", "ソウタがテストに挑戦。あなたの教え方が採点される"],
              ].map(([icon, title, desc], i) => (
                <li key={i} className="flex items-start gap-3">
                  <AppIcon name={icon as "note" | "chat" | "book" | "target"} size={24} className="text-indigo-600" />
                  <div>
